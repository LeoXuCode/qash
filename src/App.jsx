...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#08080c",color:"#ddd",fontFamily:"'Inter',sans-serif",maxWidth:480,margin:"0 auto",width:"100%",overflowX:"hidden",paddingTop:"env(safe-area-inset-top)"}}>
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",background:"rgba(18,18,22,0.95)",backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)",borderRadius:20,display:"flex",justifyContent:"center",alignItems:"center",gap:3,paddingTop:8,paddingBottom:8,paddingLeft:8,paddingRight:8,margin:"0 auto",width:"calc(100% - 24px)",maxWidth:"calc(480px - 24px)"}}>
        {TABS.map((t,i) => {
